...
import Bomberman.DynamicEntityState.action;
...
public abstract class Chips extends Component {
    ...
    public Chips(double dx, double dy, double speedFactor, double reactionForce, String assetName) {
        this.dx = dx;
        this.dy = dy;
